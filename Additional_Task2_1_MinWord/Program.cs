...
namespace Additional_Task2_1_MinWord
{
    internal static class Program
    {
        private const string StringInputMessage = "Enter string of words separated by spaces";
        private const string ResultWordsMessage = "Words with minimal length:";
        ...
        public static void Main(string[] args)
        {
            ...
            DisplayMinimalLengthWords(sortedWordsList);
        }
        ...
        private static List<string> SplitStringToOrderedList(string inputString)
        {
            ...
            return wordsList.OrderBy(x => x.Length).ToList();
        }
        ...
        /// </summary>
        private static void DisplayMinimalLengthWords(List<string> sortedList)
        {
